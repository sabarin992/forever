...
const EditProductOffer = () => {
  ...
  const { offer, products } = location.state
  ...
  const editProductOffer = async (e) => {
    ...
    try {
      const res = await api.put(`/product_offers/${offer.id}/`, productOffer)
  ...
  return (
    <>
      <h1 className="text-2xl font-bold mb-6">Edit Product Offer</h1>
...
// // useEffect(()=>{console.log(productOffer);
// // },[productOffer])
