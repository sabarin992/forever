            ...
            {activeTab === "description" ? (
              ...
              <div className="space-y-8">
                <div className="flex items-center justify-between">
                  ...
                  <button className="bg-black hover:bg-gray-700 text-white px-6 py-3 rounded-xl font-semibold transition-colors duration-200">
                    Write a Review
                  </button>
                </div>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 mt-2">
                          ...
                          outstanding and it fits perfectly. Highly recommend to
                          anyone looking for premium quality.
                        </p>
                      </div>
